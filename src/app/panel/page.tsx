...
export default function Panel() {
    ...
    const redHighlightedNumbers: string[] = ["00", "11", "22", "33", "44", "55", "66", "77", "88", "99"];
        ...
        <>
            <div className="bg-[#fc9] min-h-screen py-1">
                ...
                <div className="text-lg font-bold border-3 border-[#ff0016] mt-1 p-1">
                    <p className="text-sm text-center text-[#00094d]">{panel.panelheading}</p>
                ...
                <div className="text-lg font-bold border-1 border-black mt-1 p-1">
                    <p className="text-[22px] text-center text-[#00094d]">{panel.matkaName}</p>
                    <p className="text-[21px] text-center text-[#880e4f]">{panel.winningNumber}</p>
                                            ...
                                            {(["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"] as const).map((day) => (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between h-full gap-0.5 xs:gap-1 sm:gap-2">
                                                        ...
                                                        {/* Center Main */}
                                                        <div
                                                            className={`text-[14px] xs:text-[16px] sm:text-[23px] font-bold ${redHighlightedNumbers.includes(row[day].main)
                                                                    ? "text-red-600"
                                                                    : "text-black"
                                                                }`}
                                                        >
                ...
                <div className="bg-[#fff] text-lg font-bold border-2 border-[#800080] mt-2 p-1">
                    <h1 className="text-[35px] text-center text-[#007bff]">DPBOSS.BOSTON</h1>
                    <h2 className="text-[25px] text-center text-[#ff0000]" >All Rights Reseved®</h2>
                    <h2 className="text-[25px] text-center text-[#ff0000]">(1998-2024)</h2>
                    <h2 className="text-[25px] text-center text-[#ff0000]">Contact <span className="text-[#007bff]">(Astrologer-Dpboss)</span></h2>
                </div>
            </div>
        </>
    );
