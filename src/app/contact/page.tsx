            ...
            <div className="bg-[#fc9] min-h-screen p-2 ">
                ...
                <div className="border-2 border-[#ff0016] m-2 p-3 rounded-[10px] italic">
                    <p className="text-[12px] text-center text-[#000b65] font-bold mb-2">
                        Hello, all the Satta Matka Enthusiasts! Welcome to the contact details of our websitedpboss.Services If you are a customer and you have any queries, then you can fill out the below form here and then contact us.</p>
